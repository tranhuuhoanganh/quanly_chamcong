                    ...
                    <div class="card border-0 rounded-4 shadow-sm bg-body-tertiary h-100">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control rounded-4" v-model="formData.emp_code"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control rounded-4" v-model="formData.fullname"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="date" class="form-control rounded-4" v-model="formData.birthday"
                    ...
                    <div class="card border-0 rounded-4 shadow-sm bg-body-tertiary h-100">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="password" class="form-control rounded-4" v-model="formData.password"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="date" class="form-control rounded-4" v-model="formData.hire_date">
