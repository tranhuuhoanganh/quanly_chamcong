        ...
        <div class="modal-dialog modal-lg modal-dialog-centered">
            ...
            <div class="modal-content border-0 rounded-4 shadow-lg">
                ...
                <div class="modal-body px-4 pt-2">
                    ...
                    <form @submit.prevent="saveWorkingDay" novalidate>
...
const saveWorkingDay = async () => {
    try {
        await api.put(`working-day/update/${props.WorkingDay.day_id}`, formData)
        emit('update')
        emit('close')
    } catch (error) {
...
onMounted(
    async() => {
        Object.assign(formData,{
            work_date:props.WorkingDay.work_date,
            checkin_time:props.WorkingDay.checkin_time,
            checkout_time:props.WorkingDay.checkout_time
        })
        
        const res = await api.get(`type`)
        types.value = res.data

        if(props.WorkingDay.type_id) formData.day_type = props.WorkingDay.type.type_id
    }
)
</script>
